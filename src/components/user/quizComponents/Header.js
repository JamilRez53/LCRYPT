      ...
      <header>
        <nav className='flexSB' style={{marginLeft:"150px"}}>
          <ul className={click ? "mobile-nav" : "flexSB "} onClick={() => setClick(false)}>
            ...
            <li>
              <Link to='/usetTutorials'><Typography variant="h5">Tutorials</Typography></Link>
            </li>
            <li>
          ...
          <div className='start'>
           {userData!==null &&(<div className='button'><Typography>{userData.email?.toUpperCase()}</Typography></div>)} 
          </div>
